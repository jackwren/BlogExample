...
// Inject dbContext
builder.Services.AddDbContext<BlogExampleDbContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("BlogExampleDbConnectionString")));
